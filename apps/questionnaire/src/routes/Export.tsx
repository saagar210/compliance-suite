            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-6">
                  Your questionnaire has been processed and is ready for export. The export pack
                  will include all imported data, mapped columns, answer bank entries, and any
