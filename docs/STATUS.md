...
## Current phase + slice
- Phase 2.3 Answer bank CRUD (Questionnaire Autopilot)
...
- Phase 2.3 Answer bank CRUD (CRUD + search; deterministic ordering; audit events)

## What is in progress
- Nothing in progress

## Next steps (ordered)
1. Phase 2.4 Matching baseline (depends on Phase 2.1 + 2.3)
